...
#      - Initial release                                                      #
#     7 August, 2012                                                          #
#      - Added script to S12CBase tools                                       #
###############################################################################
...
#print header
printf $out_handle ";###############################################################################\n"; 
printf $out_handle ";# S12CBase - Image: %-50s        #\n", sprintf("%s (%d frames)", $src_file, $color_depth);
printf $out_handle ";###############################################################################\n";
printf $out_handle ";#    Copyright 2012 Dirk Heisswolf                                            #\n";
printf $out_handle ";#    This file is part of the S12CBase framework for Freescale's S12(X) MCU   #\n";
printf $out_handle ";#    families.                                                                #\n";
printf $out_handle ";#                                                                             #\n";
printf $out_handle ";#    S12CBase is free software: you can redistribute it and/or modify         #\n";
...
printf $out_handle ";#                                                                             #\n";
printf $out_handle ";#    S12CBase is distributed in the hope that it will be useful,              #\n";
...
printf $out_handle ";#    along with S12CBase.  If not, see <http://www.gnu.org/licenses/>.        #\n";
printf $out_handle ";###############################################################################\n";
