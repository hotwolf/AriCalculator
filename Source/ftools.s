...
CF_DOT_S_1		PRINT_LINE_BREAK		;(SSTACK: 11 bytes)	
			...
			LDAB	#":"			;print colon
			PRINT_CHAR
			;Print current PS cell (current index in Y)
			...
			JOB	CF_DOT_S_1
			;PS is empty 
CF_DOT_S_2		PRINT_LINE_BREAK		;new line (SSTACK: 11 bytes)
			LDX	#CF_DOT_S_MSG
...
CF_DOT_S_MSG		FCS	"Parameter stack is empty!"
