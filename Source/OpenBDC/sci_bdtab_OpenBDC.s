...
;# ------------------------------------------------------------------
;#    276 ( 114)      1 . . . . . . . (80)   2001      2       29
;#    400 ( 190)      1 1 . . . . . . (C0)   1843      1       37
;#    533 ( 215)      1 1 1 . . . . . (E0)   1184      3       46
;#    637 ( 27D)      . 1 1 . . . . . (60)    402      2       64
;#    719 ( 2CF)      2 1 1 . . . . . (E0)    352      5       73
;#    800 ( 320)      2 1 1 1 . . . . (F0)    274      4       71
;#    921 ( 399)      2 . 1 1 . . . . (B0)     91      5       80
;#   1040 ( 410)      2 2 1 1 . . . . (F0)     55      3       91
;#   1076 ( 434)      2 2 1 1 1 . . . (F8)     55      7      100
;#   1080 ( 438)      . 2 1 1 1 . . . (78)     43      6      108
;#   1162 ( 48A)      3 2 1 1 1 . . . (F8)     32      8      117
;#   1227 ( 4CB)      3 2 . 1 1 . . . (D8)     17      7      125
;#   1386 ( 56A)      3 2 2 1 1 . . . (F8)     10      9      134
;#   1522 ( 5F2)      . 2 2 1 1 . . . (78)      5      8      142
;#   1561 ( 619)      . . 2 1 1 . . . (38)      3     10      151
;#   1600 ( 640)      . . 2 1 1 1 . . (3C)      4      9      149
;#   1604 ( 644)      4 . 2 1 1 1 . . (BC)      5     10      158
;#   1680 ( 690)      4 3 2 1 1 1 . . (FC)      6      5      128
;#   1841 ( 731)      4 3 2 . 1 1 . . (EC)      5     10      137
;#   1965 ( 7AD)      . 3 2 . 1 1 . . (6C)      4      9      135
;#   2047 ( 7FF)      5 3 2 . 1 1 . . (EC)      5     10      144
;#   2080 ( 820)      5 3 2 2 1 1 . . (FC)      6      8      135
;#   2081 ( 821)      5 3 . 2 1 1 . . (DC)      5     10      144
;#   2133 ( 855)      5 3 . 2 1 1 1 . (DE)      6      9      142
;#   2201 ( 899)      5 . . 2 1 1 1 . (9E)      5     10      151
;#   2240 ( 8C0)      5 . 3 2 1 1 1 . (BE)      6      7      135
;#   2320 ( 910)      5 4 3 2 1 1 1 . (FE)      7     10      144
;#   2408 ( 968)      . 4 3 2 1 1 1 . (7E)      6      9      142
;#   2477 ( 9AD)      . 4 3 2 . 1 1 . (76)      5     10      151
;#   2490 ( 9BA)      6 4 3 2 . 1 1 . (F6)      6      8      142
;#   2799 ( AEF)      6 4 3 2 2 1 1 . (FE)      7     10      151
;#   2841 ( B19)      6 . 3 2 2 1 1 . (BE)      6      9      149
;#   2850 ( B22)      . . 3 2 2 1 1 . (3E)      5     10      158
;#   2932 ( B74)      7 . 3 2 2 1 1 . (BE)      6      6      135
;#   2934 ( B76)      7 . . 2 2 1 1 . (9E)      5     10      144
;#   2960 ( B90)      7 5 . 2 2 1 1 . (DE)      6      9      142
;#   3093 ( C15)      7 5 4 2 2 1 1 . (FE)      7     10      151
;#   3121 ( C31)      7 5 4 . 2 1 1 . (EE)      6      8      132
;#   3200 ( C80)      7 5 4 . 2 1 1 1 (EF)      7      9      149
;#   3293 ( CDD)      . 5 4 . 2 1 1 1 (6F)      6     10      158
;#   3360 ( D20)      . 5 4 3 2 1 1 1 (7F)      7      7      132
;#   3375 ( D2F)      8 5 4 3 2 1 1 1 (FF)      8      9      149
;#   3481 ( D99)      8 . 4 3 2 1 1 1 (BF)      7     10      158
;#   3600 ( E10)      8 6 4 3 2 1 1 1 (FF)      8      8      149
;#   3681 ( E61)      8 6 4 3 2 . 1 1 (FB)      7     10      158
;#   3736 ( E98)      . 6 4 3 2 . 1 1 (7B)      6      9      156
;#   3787 ( ECB)      . 6 . 3 2 . 1 1 (5B)      5     10      165
;#   3818 ( EEA)      9 6 . 3 2 . 1 1 (DB)      6      4      128
;#   3946 ( F6A)      9 6 5 3 2 . 1 1 (FB)      7     10      137
;#   4121 (1019)      9 . 5 3 2 . 1 1 (BB)      6      9      135
;#   4160 (1040)      9 . 5 3 2 2 1 1 (BF)      7     10      144
;#   4178 (1052)      . . 5 3 2 2 1 1 (3F)      6      8      135
;#   4200 (1068)      . . 5 3 . 2 1 1 (37)      5     10      144
;#   4240 (1090)      . 7 5 3 . 2 1 1 (77)      6      9      142
;#   4401 (1131)      . 7 5 . . 2 1 1 (67)      5     10      151
;#   4522 (11AA)      . 7 5 . 3 2 1 1 (6F)      6      7      135
;#   4640 (1220)      . 7 5 4 3 2 1 1 (7F)      7     10      144
;#   4641 (1221)      . 7 . 4 3 2 1 1 (5F)      6      9      142
;#   4761 (1299)      . . . 4 3 2 1 1 (1F)      5     10      151
;#   4800 (12C0)      . . 6 4 3 2 1 1 (3F)      6      8      132
;#   4880 (1310)      . 8 6 4 3 2 1 1 (7F)      7      9      149
;#   4907 (132B)      . 8 6 4 3 2 . 1 (7D)      6     10      158
;#   5401 (1519)      . . 6 4 3 2 . 1 (3D)      5      6      135
;#   5494 (1576)      . . . 4 3 2 . 1 (1D)      4     10      144
;#   5520 (1590)      . 9 . 4 3 2 . 1 (5D)      5      9      142
;#   5546 (15AA)      . 9 . 4 3 2 2 1 (5F)      6     10      151
;#   5653 (1615)      . 9 7 4 3 2 2 1 (7F)      7      8      142
;#   5681 (1631)      . 9 7 . 3 2 2 1 (6F)      6     10      151
;#   5920 (1720)      . 9 7 5 3 2 2 1 (7F)      7      9      149
;#   5922 (1722)      . 9 7 5 . 2 2 1 (77)      6     10      158
;#   6041 (1799)      . . 7 5 . 2 2 1 (37)      5      7      142
;#   6241 (1861)      . . 7 5 . . 2 1 (33)      4     10      151
;#   6244 (1864)      . . 7 5 4 . 2 1 (3B)      5      9      159
;#   6347 (18CB)      . . . 5 4 . 2 1 (1B)      4     11      168
;#   6506 (196A)      . . 8 5 4 . 2 1 (3B)      5     10      158
;#   6720 (1A40)      . . 8 5 4 3 2 1 (3F)      6      8      149
;#   6961 (1B31)      . . 8 . 4 3 2 1 (2F)      5     10      158
;#   7200 (1C20)      . . 8 6 4 3 2 1 (3F)      6      9      156
;#   7201 (1C21)      . . . 6 4 3 2 1 (1F)      5     10      165
;#   7360 (1CC0)      . . 9 6 4 3 2 1 (3F)      6      5      135
;#   7361 (1CC1)      . . 9 6 4 3 2 . (3E)      5     10      144
;#   7645 (1DDD)      . . 9 6 . 3 2 . (36)      4      9      142
;#   7967 (1F1F)      . . 9 6 5 3 2 . (3E)      5     10      159
;#   8054 (1F76)      . . . 6 5 3 2 . (1E)      4     11      168
;#   8241 (2031)      . . . . 5 3 2 . ( E)      3      8      142
;#   8320 (2080)      . . . . 5 3 2 2 ( F)      4     10      159
;#   8321 (2081)      . . . . 5 3 . 2 ( D)      3     11      168
;#   8480 (2120)      . . . 7 5 3 . 2 (1D)      4      9      159
;#   8801 (2261)      . . . 7 5 . . 2 (19)      3     11      168
;#   8960 (2300)      . . . 7 5 . 3 2 (1B)      4     10      158
;#   9280 (2440)      . . . 7 5 4 3 2 (1F)      5      7      142
;#   9368 (2498)      . . . 7 . 4 3 2 (17)      4     10      159
;#   9521 (2531)      . . . . . 4 3 2 ( 7)      3     11      168
;#   9690 (25DA)      . . . . 6 4 3 2 ( F)      4      9      149
;#   9760 (2620)      . . . 8 6 4 3 2 (1F)      5     10      166
;#  10801 (2A31)      . . . . 6 4 3 2 ( F)      4     11      175
;#  11040 (2B20)      . . . 9 6 4 3 2 (1F)      5      8      149
;#  11090 (2B52)      . . . 9 . 4 3 2 (17)      4     10      166
;#  11361 (2C61)      . . . 9 . . 3 2 (13)      3     11      175
;#  11412 (2C94)      . . . 9 7 . 3 2 (1B)      4      9      166
;#  11734 (2DD6)      . . . 9 7 . . 2 (19)      3     11      175
;#  11840 (2E40)      . . . 9 7 5 . 2 (1D)      4     10      165
;#  12081 (2F31)      . . . . 7 5 . 2 ( D)      3      6      152
;#  12373 (3055)      . . . . 7 5 4 2 ( F)      4     11      161
;#  12481 (30C1)      . . . . 7 5 4 . ( E)      3     10      159
;#  12813 (320D)      . . . . . 5 4 . ( 6)      2     11      168
;#  13135 (334F)      . . . . 8 5 4 . ( E)      3      9      149
;#  13440 (3480)      . . . . 8 5 4 3 ( F)      4     10      166
;#  13921 (3661)      . . . . 8 . 4 3 ( B)      3     11      175
;#  14400 (3840)      . . . . 8 6 4 3 ( F)      4      8      159
;#  14536 (38C8)      . . . . . 6 4 3 ( 7)      3     11      168
;#  14858 (3A0A)      . . . . 9 6 4 3 ( F)      4     10      158
;#  15147 (3B2B)      . . . . 9 6 . 3 ( D)      3      9      166
;#  15786 (3DAA)      . . . . 9 6 5 3 ( F)      4     11      175
;#  16258 (3F82)      . . . . . 6 5 3 ( 7)      3     10      173
;#  16481 (4061)      . . . . . . 5 3 ( 3)      2     11      182
;#  16960 (4240)      . . . . . 7 5 3 ( 7)      3      7      159
;#  17601 (44C1)      . . . . . 7 5 . ( 6)      2     11      168
;#  18560 (4880)      . . . . . 7 5 4 ( 7)      3     10      166
;#  18561 (4881)      . . . . . 7 . 4 ( 5)      2     11      183
;#  19041 (4A61)      . . . . . . . 4 ( 1)      1     12      192
;#  19200 (4B00)      . . . . . . 6 4 ( 3)      2      9      166
;#  19520 (4C40)      . . . . . 8 6 4 ( 7)      3     11      175
;#  21601 (5461)      . . . . . . 6 4 ( 3)      2     10      183
;#  21974 (55D6)      . . . . . . . 4 ( 1)      1     12      192
;#  22080 (5640)      . . . . . 9 . 4 ( 5)      2     11      182
;#  22613 (5855)      . . . . . 9 7 4 ( 7)      3      8      166
;#  22721 (58C1)      . . . . . 9 7 . ( 6)      2     11      175
;#  23680 (5C80)      . . . . . 9 7 5 ( 7)      3     10      173
;#  24161 (5E61)      . . . . . . 7 5 ( 3)      2     11      190
;#  25387 (632B)      . . . . . . . 5 ( 1)      1     12      199
;#  26026 (65AA)      . . . . . . 8 5 ( 3)      2      9      183
;#  27841 (6CC1)      . . . . . . 8 . ( 2)      1     12      192
;#  28800 (7080)      . . . . . . 8 6 ( 3)      2     11      190
;#  28801 (7081)      . . . . . . . 6 ( 1)      1     12      199
;#  29440 (7300)      . . . . . . 9 6 ( 3)      2     10      190
;#  32214 (7DD6)      . . . . . . . 6 ( 1)      1     12      207
;#  32961 (80C1)      . . . . . . . . ( 0)      0     13      216
;#  33920 (8480)      . . . . . . . 7 ( 1)      1     11      207
;#  38081 (94C1)      . . . . . . . . ( 0)      0     13      216
;#  39040 (9880)      . . . . . . . 8 ( 1)      1     12      224
;#  43201 (A8C1)      . . . . . . . . ( 0)      0     14      233
;#  44160 (AC80)      . . . . . . . 9 ( 1)      1     13      231
;#  48321 (BCC1)      . . . . . . . . ( 0)      0     14      240
;#
;#       |
;#       |
;#       1
...
;# pulse length >=    0 0 0 0 0 0 0 0       weight  depth  parse time
;# ------------------------------------------------------------------
;#    420 ( 1A4)      1 . . . . . . . (80)     11      3       39
;#    608 ( 260)      1 1 . . . . . . (C0)     18      2       37
;#    810 ( 32A)      1 1 1 . . . . . (E0)     23      3       46
;#   1216 ( 4C0)      1 1 1 1 . . . . (F0)     20      1       37
;#   1636 ( 664)      1 1 1 1 1 . . . (F8)     14      3       46
;#   2432 ( 980)      1 1 1 1 1 1 . . (FC)      6      2       54
;#   3242 ( CAA)      1 1 1 1 1 1 1 . (FE)      7      4       63
;#   4864 (1300)      1 1 1 1 1 1 1 1 (FF)      8      3       53
;#
;#   |
;#   |
;#   4
...
; args:   1: root of the search tree
;         D: pulse length
; result: X: list of matching baud rates (mirrored in high and low byte)
; SSTACK: 0 bytes
;         D is preserved
#macro	SCI_BD_PARSE, 1
		LDX	#$0000		;  2 cycs	;initialize X
		LDY	#\1		;  2 cycs	;initialize Y
LOOP		TST	0,Y	     	;  3 cycs	;check if lower boundary exists
		BEQ	DONE		;1/3 cycs	;search done
		CPD	6,Y+		;  3 cycs	;check if pulse length is shorter than lower boundary
		BLO	LOOP		;1/3 cycs	;pulse length is shorter than lower boundary -> try a shorter range
		LDX	-4,Y		;  3 cycs	;new lowest boundary found -> store valid baud rate field in index X
