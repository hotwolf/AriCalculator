...
DEMO_LOOP		EXEC_CF	CF_QUERY
			LDD	NUMBER_TIB
			TBEQ	D, DEMO_LOOP

			MOVW	#10, BASE
DEMO_POS_SINGLE		EQU	1234
DEMO_NEG_SINGLE		EQU	-1234
DEMO_SINGLE_WIDTH	EQU	6	
DEMO_POS_DOUBLE		EQU	12345678
DEMO_NEG_DOUBLE		EQU	-12345678
DEMO_DOUBLE_WIDTH	EQU	10	

			PS_PUSH	#DEMO_NUM_PROMPT
			EXEC_CF	CF_STRING_DOT			
			PS_PUSH	#DEMO_POS_DOUBLE
			PS_PUSH	#DEMO_POS_DOUBLE>>16				
			PS_PUSH	#DEMO_DOUBLE_WIDTH
			EXEC_CF	CF_D_DOT_R
			...
			PS_PUSH	#DEMO_NUM_PROMPT
			EXEC_CF	CF_STRING_DOT			
			PS_PUSH	#DEMO_NEG_DOUBLE
			PS_PUSH	#DEMO_NEG_DOUBLE>>16				
			PS_PUSH	#DEMO_DOUBLE_WIDTH
			EXEC_CF	CF_D_DOT_R
			...
			PS_PUSH	#DEMO_NUM_PROMPT
			EXEC_CF	CF_STRING_DOT			
			PS_PUSH	#DEMO_POS_SINGLE
			PS_PUSH	#DEMO_SINGLE_WIDTH
			EXEC_CF	CF_DOT_R
			
			PS_PUSH	#DEMO_NUM_PROMPT
			EXEC_CF	CF_STRING_DOT
			
			PS_PUSH	#DEMO_NEG_SINGLE
			PS_PUSH	#DEMO_SINGLE_WIDTH
			EXEC_CF	CF_DOT_R
...
DEMO_RESPONSE_PROMPT	FOUTER_PROMPT	"TIB:"
DEMO_NUM_PROMPT		FOUTER_PROMPT	"NUM:"
