...
;                        |                     |                          |    Program Space    |             
;                        |                     |                          |      (Source)       |            
;                        |        SSTACK       |    LRE_TABS_START_LRE -> +----------+----------+            
;                        |        ISTACK       |                          |   Tables (source)   |            
;  	                 |                     |     LRE_VECTAB_START, -> +----------+----------+                  
;                        |                     |         VECTAB_START     |    Vector Table     |                                  
;  	                 |                     |                          +----------+----------+                  
;                        |                     |                          |                     |                             
;                        |                     |                          |       SSTACK        |                             
;                        |                     |                          |       ISTACK        |            
...
LRE_CODE_START_LIN	EQU	@
			...
			;LRE tables
			ORG	LRE_CODE_END,  LRE_CODE_END_LRE
			ALIGN	1, $FF	
LRE_TABS_START		EQU	*
LRE_TABS_START_LIN	EQU	@
			...
			;LRE vector table
#ifdef RAM_COMPILE
			ORG	LRE_TABS_END,  LRE_TABS_END_LRE
#else
			ORG	LRE_TABS_END,  $3_FF00
#endif
			ALIGN	$FF, $FF	
...
TABS_START_LIN		EQU	@
			...
			;Vector table
#ifdef RAM_COMPILE
			ORG	LRE_TABS_END_LRE,  LRE_TABS_END_LRE
#else
			ORG	$FF00,  $3_FF00
#endif
			ALIGN	$FF, $FF	
